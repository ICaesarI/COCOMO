...
// Definición de atributos en español
const attributesEs = {
...
/**
 * Crea las secciones de atributos dinámicamente en el contenedor especificado.
 * @param {string} containerId - ID del contenedor donde se agregarán las secciones.
 * @param {object} attributes - Objeto con los atributos a mostrar.
 */
...
/**
 * Calcula los resultados de COCOMO basándose en los valores seleccionados.
...
/**
 * Renderiza los resultados de COCOMO en la interfaz.
 */
...
/**
 * Traduce el modo de proyecto al español.
 * @param {string} mode - Modo de proyecto en inglés.
 * @returns {string} - Modo de proyecto traducido.
 */
...
/**
 * Alterna la visibilidad de la lista de abreviaciones.
 */
...
/**
 * Alterna el idioma entre inglés y español.
 */
...
/**
 * Aplica el tema del sistema al cargar la página.
 */
...
/**
 * Calcula los valores de Kutcher's Basic COCOMO Calculator.
 */
...
/**
 * Alterna la visibilidad de la sección de Kutcher's Basic COCOMO Calculator.
 */
